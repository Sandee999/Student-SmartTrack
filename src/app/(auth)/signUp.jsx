...
export default function SignUp() {
  ...
  async function onSubmit() {
    if(!user.name.trim()) setErrorMessage('name cannot be empty');
      ...
      await AsyncStorage.setItem('attendance', attendanceJson);
      await AsyncStorage.setItem('todo', todoJson);
      // Going to Home Page
  ...
  return (
    <>
      <KeyboardAvoidingView onTouchMove={Keyboard.dismiss} behavior='position' className={`w-[100vw] h-[100vh] bg-white mt-safe-offset-0`}>
